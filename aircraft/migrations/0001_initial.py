    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airclass', models.CharField(blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('airclass', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT,
                 to='aircraft.aircraftclass', verbose_name='Aircraft Class')),
                ...
                ('visit', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT,
                 to='locations.visit', verbose_name='Visit')),
            ],
        ),
        migrations.CreateModel(
            name='AirBMImage',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='airimages_created', to=settings.AUTH_USER_MODEL)),
                ('users_like', models.ManyToManyField(blank=True,
                 related_name='airimages_liked', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
