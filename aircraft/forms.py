...
from .models import AirImage, AirBMImage

class AirBMImageCreateForm(forms.ModelForm):
    class Meta:
        model = AirBMImage
    ...
    def save(self, force_insert=False,
               force_update=False,
               commit=True):
      image = super(AirBMImageCreateForm, self).save(commit=False)
...
class AirImageForm(forms.ModelForm):
  class Meta:
    model = AirImage
