...
class AirImage(models.Model):  # Aircraft Images
    ...
    airclass = models.ForeignKey(
        AircraftClass, default=1, verbose_name="Aircraft Class", on_delete=models.SET_DEFAULT)
    location = models.ForeignKey(
        'locations.HeritageSite', default=1, verbose_name="Location", on_delete=models.SET_DEFAULT)
    visit = models.ForeignKey('locations.Visit', default=1,
                              verbose_name="Visit", on_delete=models.SET_DEFAULT)
