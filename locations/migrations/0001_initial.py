...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(blank=True, default=None, help_text='Enter a slug only if you wish to override that which will be autogenerated', max_length=255, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.CharField(blank=True, default=None, help_text='Enter a slug only if you wish to override that which will be autogenerated', max_length=255, null=True)),
                ('wikiname', models.CharField(blank=True, max_length=200, null=True)),
                ('wikislug', models.CharField(blank=True, default=None, max_length=250, null=True)),
                ...
                ('closed_to_steam', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linear_reference', models.DecimalField(blank=True, decimal_places=2, default=None, max_digits=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(choices=[(1, 'Official Opening'), (2, 'Closed to Passengers'), (3, 'Closed to Freight'), (4, 'Razed'), (5, 'Name Change'), (6, 'Ownership Change'), (7, 'Construction Approved'), (99, 'Other')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='locations.location')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='location',
            name='categories',
            field=models.ManyToManyField(blank=True, related_name='locations_in_category', to='locations.LocationCategory'),
        ),
        migrations.AddField(
            model_name='location',
            name='custom_post',
        ...
        migrations.AddField(
            model_name='location',
            name='elrs',
            field=models.ManyToManyField(blank=True, related_name='locations_on_elr', through='locations.ELRLocation', to='locations.ELR'),
        ),
        migrations.AddField(
            model_name='location',
            name='owner_operators',
            field=models.ManyToManyField(blank=True, related_name='locations_owned_or_operated', to='companies.Company'),
        ),
        migrations.AddField(
            model_name='location',
            name='posts',
            field=models.ManyToManyField(blank=True, related_name='locations_in_post', to='notes.Post'),
        ),
        migrations.AddField(
            model_name='location',
            name='references',
            field=models.ManyToManyField(blank=True, related_name='locations_references', to='notes.Reference'),
        ),
        migrations.AddField(
