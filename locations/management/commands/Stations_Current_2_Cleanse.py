...
Wikipedia_file = os.path.join(DATAIO_DIR, 'Location_Extract_Wikipedia_Stations.csv')
...
output_file = os.path.join(DATAIO_DIR, 'Location_Joined_onCrsCode.csv')
...
output_file = os.path.join(DATAIO_DIR, 'Location_Extract_Fuzzy_Analysis.csv')
...
df.index.name='Name'
df.reset_index()
output_file = os.path.join(DATAIO_DIR, 'Location_Extract_Joined.csv')
...
output_file = os.path.join(DATAIO_DIR, 'Location_LoadFile.csv')
