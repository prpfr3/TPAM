...
class ELRLocation(models.Model):
    ...
    elr_fk = models.ForeignKey(
        ELR, blank=True, null=True, on_delete=models.CASCADE)
...
class RouteGeoOsm(models.Model):
    ...
    colour_infill = models.TextField(
        db_column='colour:infill', blank=True, null=True)
    ...
    ref_colour_bg = models.TextField(
        db_column='ref:colour_bg', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    ref_colour_tx = models.TextField(
        db_column='ref:colour_tx', blank=True, null=True)
    ...
    operator_cy = models.TextField(
        db_column='operator:cy', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    operator_en = models.TextField(
        db_column='operator:en', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    note_colour = models.TextField(
        db_column='note:colour', blank=True, null=True)
    ...
    source_name_oc = models.TextField(
        db_column='source:name:oc', blank=True, null=True)
    ...
    cargo_vehicle = models.TextField(
        db_column='cargo:vehicle', blank=True, null=True)
    ...
    field_relations = models.TextField(
        db_column='@relations', blank=True, null=True)
    # Geometry Field if using contrib.gis
    geometry = models.TextField(blank=True, null=True)
...
class RouteGeoOsmhistory(models.Model):
    ...
    name_1863_1908 = models.TextField(
        db_column='name:1863-1908', blank=True, null=True)
    alt_name = models.TextField(blank=True, null=True)
    operator = models.TextField(blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    name_1848_1966 = models.TextField(
        db_column='name:1848-1966', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    name_1966_2021 = models.TextField(
        db_column='name:1966-2021', blank=True, null=True)
    ...
    name_1847_1922 = models.TextField(
        db_column='name:1847-1922', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    name_1922 = models.TextField(db_column='name:1922', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    company_1898 = models.TextField(
        db_column='company:1898', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    company_end = models.TextField(
        db_column='company:end', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    company_start = models.TextField(
        db_column='company:start', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    end_date_goods = models.TextField(
        db_column='end_date:goods', blank=True, null=True)
    gauge = models.TextField(blank=True, null=True)
    # Field name made lowercase. Field renamed to remove unsuitable characters.
    start_date_gwr = models.TextField(
        db_column='start_date:GWR', blank=True, null=True)
    ...
    name_1886_1937 = models.TextField(
        db_column='name:1886-1937', blank=True, null=True)
    # Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    name_1937_field = models.TextField(
        db_column='name:1937-', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    source_data = models.TextField(
        db_column='source:data', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    name_1932_1934 = models.TextField(
        db_column='name:1932-1934', blank=True, null=True)
    # Field renamed to remove unsuitable characters.
    name_1881_1895 = models.TextField(
        db_column='name:1881-1895', blank=True, null=True)
...
class HeritageSite(models.Model):
    ...
    tpam_type = models.ForeignKey('mainmenu.MyDjangoApp', default=1,
                                  verbose_name="Heritage Site Type", on_delete=models.SET_DEFAULT)
...
class Visit(models.Model):  # Visit to a Location / Heritage Site
    location = models.ForeignKey(
        HeritageSite, default=1398, verbose_name="Location", on_delete=models.SET_DEFAULT)
