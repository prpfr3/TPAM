# Generated by Django 3.2.1 on 2022-02-04 10:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slide_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='locos.slide')),
                ('slideheader_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='locos.slideheader')),
            ],
        ),
        migrations.AddField(
            model_name='slide',
            name='slideheader',
            field=models.ManyToManyField(related_name='slidepack_slide', through='locos.Slidepack', to='locos.SlideHeader'),
        ),
    ]
