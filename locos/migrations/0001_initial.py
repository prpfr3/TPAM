    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driving_unit_wheelbase', models.CharField(blank=True, default='', max_length=200)),
                ...
                ('length_over_buffers', models.CharField(blank=True, default='', max_length=200)),
                ...
                ('number_of_tubes', models.CharField(blank=True, default='', max_length=700)),
                ...
                ('pony_wheel_diameter', models.CharField(blank=True, default='', max_length=200)),
                ...
                ('remanufacturer', models.CharField(blank=True, default='', max_length=200)),
                ...
                ('superheater_elements', models.CharField(blank=True, default='', max_length=200)),
                ...
                ('tube_length', models.CharField(blank=True, default='', max_length=200)),
                ('tube_diameter_outside', models.CharField(blank=True, default='', max_length=200)),
                ...
                ('designer_company', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='companies.company')),
                ('designer_person', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='people.person')),
                ('manufacturers', models.ManyToManyField(blank=True, related_name='lococlass_manufacturers', to='companies.Manufacturer')),
                ('owner_operators', models.ManyToManyField(blank=True, related_name='lococlass_owner_operators', to='companies.Company')),
                ('post_fk', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='notes.post')),
                ('references', models.ManyToManyField(blank=True, related_name='lococlass_references', to='notes.Reference')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_as_built', models.CharField(blank=True, max_length=20, null=True)),
                ('number_pregrouping_1', models.CharField(blank=True, max_length=20, null=True)),
                ('number_pregrouping_1_date', models.CharField(blank=True, max_length=10, null=True)),
                ('number_pregrouping_2', models.CharField(blank=True, max_length=20, null=True)),
                ('number_pregrouping_2_date', models.CharField(blank=True, max_length=10, null=True)),
                ('number_grouping_1', models.CharField(blank=True, max_length=20, null=True)),
                ('number_grouping_1_date', models.CharField(blank=True, max_length=10, null=True)),
                ('number_grouping_2', models.CharField(blank=True, max_length=20, null=True)),
                ('number_grouping_2_date', models.CharField(blank=True, max_length=10, null=True)),
                ('number_postgrouping_1', models.CharField(blank=True, max_length=20, null=True)),
                ('number_postgrouping_1_date', models.CharField(blank=True, max_length=10, null=True)),
                ('number_postgrouping_2', models.CharField(blank=True, max_length=20, null=True)),
                ('number_postgrouping_2_date', models.CharField(blank=True, max_length=10, null=True)),
