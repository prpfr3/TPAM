...
Wikipedia_file = os.path.join(DATAIO_DIR, 'Locations_Extract_Wikipedia_Closed_Stations.csv')
Disused_file = os.path.join(DATAIO_DIR, 'Locations_Extract_Disused_Stations.csv')
...
df.reset_index(inplace=True)
output_file = os.path.join(DATAIO_DIR, 'Locations_Disused_Extract_Joined.csv')
