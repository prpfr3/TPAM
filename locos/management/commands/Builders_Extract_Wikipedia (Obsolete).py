"""
 Extracts British Locomotive Builder data from Wikipedia
"""
import requests, csv, os, re
from bs4 import BeautifulSoup
from urllib.request import urlopen

url = "https://en.wikipedia.org/wiki/Category:Locomotive_builder_of_the_United_Kingdom"
DATAIO_DIR = os.path.join("D:\\Data", "TPAM")
output_file = os.path.join(DATAIO_DIR, 'Builder_Extract_Wikipedia.csv')
