"""
 Extracts British Locomotive Builder data from BRD Website
"""
...
output_file = os.path.join(DATAIO_DIR, 'Builder_Extract_BRD.csv')
csvFile = open(output_file, 'wt+', newline='', encoding='utf-8')
output = csv.writer(csvFile, delimiter=',', quoting=csv.QUOTE_MINIMAL)

if url_or_file == "url":
    url = "https://www.brdatabase.info/sites.php?page=builders&action=list"
    ...
    res = open(os.path.join(DATAIO_DIR, "Builder_BRD.html"))
