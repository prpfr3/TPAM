...
class LocomotiveAdmin(admin.ModelAdmin):
    list_display = ["identifier", "number_pregrouping",
                    "number_grouping", "number_postgrouping"]
    list_filter = ['company_pregrouping_code',
                   'company_grouping_code', 'manufacturer']
    search_fields = ("identifier", "number_pregrouping",
                     "number_grouping", "number_postgrouping")
    ordering = ("identifier",)
