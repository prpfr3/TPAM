...
def loco_class(request, loco_class_id):
  ...
  class_designers2 = loco_class.manufacturer_designer.all()  
  class_designers3 = loco_class.company_designer.all()
  class_designers = list(chain(class_designers2, class_designers3))
  # class_manufacturers1 = loco_class.person_manufacturer.all()
  class_manufacturers2 = loco_class.manufacturer_manufacturer.all()
  class_manufacturers3 = loco_class.company_manufacturer.all()
  class_manufacturers = list(chain(class_manufacturers2, class_manufacturers3))
...
def locomotive(request, locomotive_id):
    ...
    try:
      ...
      class_manufacturers = list(chain(class_manufacturers1, class_manufacturers2, class_manufacturers3))
...
def photos(request):
  photos = Reference.objects.filter(type='6').order_by('citation')
