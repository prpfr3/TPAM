    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wikipedia_name', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slide_fk', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='storymaps.slide')),
                ('slideheader_fk', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='storymaps.slideheader')),
            ],
        ),
        migrations.AddField(
            model_name='slide',
            ...
            field=models.ManyToManyField(
                related_name='slidepack_slide', through='storymaps.Slidepack', to='storymaps.SlideHeader'),
        ),
    ]
