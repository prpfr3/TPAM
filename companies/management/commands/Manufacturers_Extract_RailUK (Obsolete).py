"""
 Extracts British Locomotive Manufacturer list from RailUK
"""
...
url = "https://railuk.info/steam/manufacturer_search.php"
url_or_file = "file" #set to 'url' or 'file'
DATAIO_DIR = os.path.join("D:\\Data", "TPAM")
output_file = os.path.join(DATAIO_DIR, 'Manufacturer_Extract_RailUK.csv')
...
if url_or_file == "url":
    ...
    res = open(os.path.join(DATAIO_DIR, "Manufacturer_Extract_RailUK.html"))
