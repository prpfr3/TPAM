...
class Company(models.Model):
  ...
  lococlass_built = models.ManyToManyField(LocoClass, through='ClassManufacturer', related_name="company_manufacturer")
...
class Manufacturer(models.Model):
  ...
  post_fk = models.ForeignKey(Post, on_delete=models.SET_NULL, blank=True, null=True, default=None)
  lococlass_designed = models.ManyToManyField(LocoClass, through='ClassDesigner', related_name="manufacturer_designer")
  lococlass_built = models.ManyToManyField(LocoClass, through='ClassManufacturer', related_name="manufacturer_manufacturer")
...
class ClassManufacturer(models.Model): 
  ...
  manufacturer_fk = models.ForeignKey(Manufacturer, blank=True, null=True, on_delete=models.CASCADE)
