...
class LocosClosedRoutesGeodata(models.Model):
...
class LocosDepots(models.Model):
...
class LocosLocations(models.Model):
...
class LocosRoute(models.Model):
    name = models.CharField(max_length=1000)
    wikipedia_slug = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'locos_route'


class LocosRouteLocations(models.Model):
    route = models.ForeignKey(LocosRoute, models.DO_NOTHING)
    locations = models.ForeignKey(LocosLocations, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'locos_route_locations'
        unique_together = (('route', 'locations'),)


class LocosRouteWikipediaRouteCategories(models.Model):
    route = models.ForeignKey(LocosRoute, models.DO_NOTHING)
    routecategory = models.ForeignKey('LocosRoutecategory', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'locos_route_wikipedia_route_categories'
        unique_together = (('route', 'routecategory'),)


class LocosRouteWikipediaRoutemaps(models.Model):
    route = models.ForeignKey(LocosRoute, models.DO_NOTHING)
    routemap = models.ForeignKey('LocosRoutemap', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'locos_route_wikipedia_routemaps'
        unique_together = (('route', 'routemap'),)


class LocosRoutecategory(models.Model):
    category = models.CharField(max_length=100, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'locos_routecategory'


class LocosRoutelocation(models.Model):
    routemap_fk = models.ForeignKey('LocosRoutemap', models.DO_NOTHING)
    loc_no = models.IntegerField()
    location_fk = models.ForeignKey(LocosLocations, models.DO_NOTHING, blank=True, null=True)
    item = models.CharField(max_length=1000, blank=True, null=True)
    type = models.CharField(max_length=10, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'locos_routelocation'


class LocosRoutemap(models.Model):
    name = models.CharField(max_length=1000, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'locos_routemap'


class LocosRouteowneroperator(models.Model):
    company_fk = models.ForeignKey(LocosCompany, models.DO_NOTHING)
    route_fk = models.ForeignKey(LocosRoute, models.DO_NOTHING)
