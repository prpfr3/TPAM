...
class Visit(models.Model):  # Visit to a Location / Heritage Site
    location = models.ForeignKey(
        HeritageSite, default=1, verbose_name="Location", on_delete=models.SET_DEFAULT)
...
class MVImage(models.Model):  # Military Vehicle Images
    ...
    mvclass = models.ForeignKey(MilitaryVehicleClass, default=1,
                                verbose_name="Military Vehicle Class", on_delete=models.SET_DEFAULT)
    location = models.ForeignKey(
        HeritageSite, default=1, verbose_name="Location", on_delete=models.SET_DEFAULT)
    visit = models.ForeignKey(
        Visit, default=1, verbose_name="Visit", on_delete=models.SET_DEFAULT)
    notes = models.TextField(default=None, blank=True, null=True)
    date_added = models.DateTimeField(auto_now_add=True)
...
class MVBMImage(models.Model):
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name='mvimages_created', on_delete=models.CASCADE)
