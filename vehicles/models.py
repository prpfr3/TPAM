...
class VehicleMake(models.Model):
    ...
    type = models.ForeignKey(VehicleType, default=None,
                             verbose_name="Vehicle Type", on_delete=models.SET_DEFAULT)
...
class VehicleModel(models.Model):
    ...
    date_added = models.DateTimeField(auto_now_add=True)
    make = models.ForeignKey(VehicleMake, default=None,
                             verbose_name="Vehicle Make", on_delete=models.SET_DEFAULT)
...
class VehicleVariant(models.Model):
    ...
    date_added = models.DateTimeField(auto_now_add=True)
    model = models.ForeignKey(VehicleModel, default=None,
                              verbose_name="Vehicle Model", on_delete=models.SET_DEFAULT)
...
class UKLicensedVehicles(models.Model):
    ...
    type = models.ForeignKey(VehicleType, default=None, null=True, verbose_name="Vehicle Type",
                             on_delete=models.SET_DEFAULT)  # Added for smart selects
...
class VehicleBMImage(models.Model):
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name='rvimages_created', on_delete=models.CASCADE)
    ...
    users_like = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name='rvimages_liked', blank=True)
