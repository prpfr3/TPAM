    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, blank=True, chained_field='make', chained_model_field='make', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='vehicles.vehiclemodel')),
                ...
                ('variant', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, blank=True, chained_field='model', chained_model_field='model', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='vehicles.vehiclevariant')),
            ],
            options={
